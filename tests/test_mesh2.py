...
def test_ref():
    ...
    ells = (0, 2, 4)
    ref = {'x': 1.6458452166543525, 'firstpoint': 1.595846395363735, 'endpoint': 1.595846395363735}
    bin = BinMesh2SpectrumPoles(mattrs, edges={'step': 4 * mattrs.kfun.min()}, ells=ells)
    result = {}
    ...
    ref = {('x', None): 4.247522247532211e-06, ('firstpoint', None): 4.131427316273581e-06, ('endpoint', None): 4.131427316273581e-06,
    ('x', 'bessel'): 4.247522247532211e-06, ('firstpoint', 'bessel'): 4.131427316273581e-06, ('endpoint', 'bessel'): 4.131427316273581e-06}
    result = {}
